...
async def init():
    ...
    migrations = [
        ...
        # Convert old 'defence' to 'constitution' if still present (for very old schemas)
                "ALTER TABLE rpg_characters ADD COLUMN IF NOT EXISTS vitality INTEGER NOT NULL DEFAULT 10",
        "ALTER TABLE rpg_characters ADD COLUMN IF NOT EXISTS char_level INTEGER NOT NULL DEFAULT 1",
        "ALTER TABLE rpg_characters ADD COLUMN IF NOT EXISTS char_xp INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE rpg_characters ADD COLUMN IF NOT EXISTS race TEXT NOT NULL DEFAULT 'Human'",
        "ALTER TABLE rpg_characters ADD COLUMN IF NOT EXISTS cd_remover_charges INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE social ADD COLUMN IF NOT EXISTS tease_count INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE social ADD COLUMN IF NOT EXISTS slap_count INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE social ADD COLUMN IF NOT EXISTS poke_count INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE social ADD COLUMN IF NOT EXISTS bite_count INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE social ADD COLUMN IF NOT EXISTS wave_count INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE social ADD COLUMN IF NOT EXISTS cuddle_count INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE social ADD COLUMN IF NOT EXISTS lick_count INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE auction_house ADD COLUMN IF NOT EXISTS category TEXT NOT NULL DEFAULT 'other'",
